...
def a_pcstable(a_sample, a_test, a_common_params):
    ...
    pc = PCStable(dataframe=dataframe, cond_ind_test=a_test, verbosity=VERBOSITY)
...
@pytest.fixture()
def a_run_pc_stable(a_pcstable, a_pc_stable_params):
    # Unpack PC, true parents, and common parameters
    pc, true_parents, tau_min, tau_max, _ = a_pcstable
